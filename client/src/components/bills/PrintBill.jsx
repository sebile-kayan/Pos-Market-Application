...
//!Home'da Faturalara bastıktan sonra çıkan ekranda yazdır butonuna basınca önümüze gelen ekran.
/*
scope="col"  :bu başlığın ilgili sütunun başlığı olduğunu belirtir. 
*/
        ...
        <div className="max-w-5xl mx-auto bg-white px-6">
          <article className="overflow-hidden">
            <div className="logo my-6">
              <h2 className="text-4xl font-bold text-slate-700">HOP-AL</h2>
            </div>
            <div className="bill-details">
              <div className="grid sm:grid-cols-4 grid-cols-3 gap-12">
                <div className="text-md text-slate-500">
                  <p className="font-bold text-slate-700">Fatura Detayı:</p>
                  <p className="text-purple-700">{customer?.customerName}</p>
                  <p>Ürün Satın Alma</p>
                  <p> Hop-al </p>
                </div>
                <div className="text-md text-slate-500">
                  ...
                  {customer?.cartItems.map((item) => (
                    <tr className="border-b border-slate-200">
                      ...
                      <td className="py-4 text-end">
                        <span>{item.price * item.quantity.toFixed(2)}.00₺</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
