...
const Register = () => {
  ...
  //Başlangıçta: loading durumu false olarak başlatılır. Bu, butonun başlangıçta normal bir şekilde görüneceği ve tıklanabilir olacağı anlamına gelir.
  ...
  const onFinish = async (values) => {
    ...
    //Çünkü kaydol butonunun yüklenme özelliğine bu state'i atadık.
    try {
          ...
          <Form layout="vertical" onFinish={onFinish}>
            ...
            <Form.Item>
              <Button
                ...
                size="large"
                loading={loading}
                //loading={loading} ifadesi, kullanıcıya bir işlem yapıldığını gösterir ve bu sırada butonun tekrar tıklanmasını engeller. 
              >
                Kaydol
              </Button>
            </Form.Item>
            ...
            <div className="w-full">
              <Carousel autoplay className="!h-full px-6">
                ...
                <AuthCarousel
                  ...
                  desc="Deneyim Sonunda Üründen Memnun Müşteriler" //tanım metni
                />
                <AuthCarousel
